...
(function (root, factory) {
  if(typeof define === "function" && define.amd) {
    define(["./bglib-errors", "./data-utils"], factory);
  } else {
    module.exports = factory(require("./bglib-errors"), require("./data-utils"));
  }
}(this, function(errorHandler, dataUtils) {

    /***************************************
    *		SYSTEM RESPONSES
    ****************************************/
    var _bgResponseReset = function(params) {
        this.dfu = dataUtils.readUInt8(params,0);
    }
    ...
    var _bgResponseGetCounters = function(params) {
        this.txok = dataUtils.readUInt8(params,0);
        this.txretry = dataUtils.readUInt8(params,1);
        this.rxok = dataUtils.readUInt8(params,2);
        this.rxfail = dataUtils.readUInt8(params,3);
        this.mbuf = dataUtils.readUInt8(params,4);
    }

    var _bgResponseGetConnections = function(params) {
        this.maxconn = dataUtils.readUInt8(params,0);
    }
    ...
    var _bgResponseGetInfo = function(params) {
        ...
        this.llversion = dataUtils.readUInt16LE(params,8)
    ...
    var _bgResponseEndpointTx = function(params) {
        this.result = errorHandler.getErrorFromCode(dataUtils.readUInt16LE(params,0));
    }
    ...
    var _bgResponseEndpointRx = function(params) {
        this.result  = errorHandler.getErrorFromCode(dataUtils.readUInt16LE(params,0));
        this.size = dataUtils.readUInt8(params,2);
    }
    ...
    ****************************************/
    ...
    var _bgResponseAttributesRead = function(params) {
        ...
        this.offset = dataUtils.readUInt16LE(params,2)
        this.result = errorHandler.getErrorFromCode(dataUtils.readUInt16LE(params,4));
        this.value = params.slice(7, 7 + params[6]);
    }
    var _bgResponseAttributesReadType = function(params) {
        this.handle = dataUtils.readUInt16LE(params,0)
        this.result = errorHandler.getErrorFromCode(dataUtils.readUInt16LE(params,2));
    ...
    ****************************************/
    ...
    var _bgResponseConnectionGetRSSI = function(params) {
        this.connection = dataUtils.readUInt8(params,0);
        this.rssi = dataUtils.readInt8(params,1);
    }
    ...
    ****************************************/
    ...
    var _bgResponseSMGetBonds = function(params) {
        this.bonds = dataUtils.readUInt8(params,0);
    }
    ...
    ****************************************/
    ...
    var _bgResponseGAPConnectDirect = function(params) {
        this.result = errorHandler.getErrorFromCode(dataUtils.readUInt16LE(params,0));
        this.connection_handle = dataUtils.readUInt8(params,2);
    }
    ...
    ****************************************/
    ...
    var _bgResponseHWIOPortRead = function(params) {
        this.result = errorHandler.getErrorFromCode(dataUtils.readUInt16LE(params,0));
        this.port = dataUtils.readUInt8(params,2);
        this.data = dataUtils.readUInt8(params,3);
    }
    ...
    var _bgResponseHWIOSPITransfer = function(params) {
        this.result = errorHandler.getErrorFromCode(dataUtils.readUInt16LE(params,0));
        this.channel = dataUtils.readUInt8(params,2);
    ...
    var _bgResponseHWI2CWrite = function(params) {
        this.written = dataUtils.readUInt8(params,0);
    }
    ...
    ****************************************/
    ...
    var _bgResponseTestGetChannelMap = function(params) {
        this.channel_map = dataUtils.readUInt8(params,0);
    }
