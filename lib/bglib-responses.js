...
(function (root, factory) {
  if(typeof define === "function" && define.amd) {
    define(["./getErrorFromCode"], factory);
  } else {
    module.exports = factory(require("./getErrorFromCode"));
  }
}(this, function(getErrorFromCode) {
    /***************************************
    *		SYSTEM RESPONSES
    ****************************************/
    ...
    var _bgResponseEndpointTx = function(params) {
        this.result = getErrorFromCode(params.readUInt16LE(0));
    }
    ...
    ****************************************/
    ...
    var _bgResponseAttributesRead = function(params) {
        ...
        this.result = getErrorFromCode(params.readUInt16LE(4));
        this.value = params.slice(7, 7 + params[6]);
    }
    var _bgResponseAttributesReadType = function(params) {
        this.handle = params.readUInt16LE(0)
        this.result = getErrorFromCode(params.readUInt16LE(2));
    ...
    ****************************************/
    ...
    var _bgResponseConnectionUpdate = function(params) {
        this.connection = params.readUInt8(0);
        this.result = getErrorFromCode(params.readUInt16LE(1));
    }
