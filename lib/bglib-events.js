...
(function (root, factory) {
  if(typeof define === "function" && define.amd) {
    define(["./bglib-errors", "bleadvertise"], factory);
  } else {
    module.exports = factory(require("./bglib-errors"), require("bleadvertise"));
  }
}(this, function(errorHandler, dataParser) {
    ...
    ****************************************/
    ...
    var _bgEventSystemScriptFailure = function(params) {
        ...
        this.reason = errorHandler.getErrorFromCode.getErrorFromCode(params.readUInt16LE(2));
    }
    var _bgEventSystemNoLicenseKey = function(params) {

    }
    var _bgEventSystemProtocolError = function(params) {
        this.reason = errorHandler.getErrorFromCode.getErrorFromCode(params.readUInt16LE(0));
    }
    ...
    ****************************************/
    ...
    var _bgEventConnectionDisconnected = function(params) {
        this.connection = params.readUInt8(0);
        this.reason = errorHandler.getErrorFromCode.getErrorFromCode(params.readUInt16LE(1));
    }
    ...
    ****************************************/
    ...
    var _bgEventAttClientProcedureCompleted = function(params) {
        this.connection = params.readUInt8(0);
        this.result = errorHandler.getErrorFromCode.getErrorFromCode(params.readUInt16LE(1));
