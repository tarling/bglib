...
(function (root, factory) {
  if(typeof define === "function" && define.amd) {
    define(["./bglib-errors", "./data-utils", "bleadvertise"], factory);
  } else {
    module.exports = factory(require("./bglib-errors"), require("./data-utils"), require("bleadvertise"));
  }
}(this, function(errorHandler, dataUtils, dataParser) {
    ...
    ****************************************/
    ...
    var _bgEventSystemScriptFailure = function(params) {
        ...
        this.reason = errorHandler.getErrorFromCode.getErrorFromCode(dataUtils.readUInt16LE(params,2));
    }
    var _bgEventSystemNoLicenseKey = function(params) {

    }
    var _bgEventSystemProtocolError = function(params) {
        this.reason = errorHandler.getErrorFromCode.getErrorFromCode(dataUtils.readUInt16LE(params,0));
    }
    ...
    ****************************************/
    ...
    var _bgEventConnectionDisconnected = function(params) {
        this.connection = dataUtils.readUInt8(params,0);
        this.reason = errorHandler.getErrorFromCode.getErrorFromCode(dataUtils.readUInt16LE(params,1));
    }
    ...
    ****************************************/
    ...
    var _bgEventAttClientProcedureCompleted = function(params) {
        this.connection = dataUtils.readUInt8(params,0);
        this.result = errorHandler.getErrorFromCode.getErrorFromCode(dataUtils.readUInt16LE(params,1));
